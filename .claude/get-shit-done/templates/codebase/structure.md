...
- Usage: Reference from command with `@/Users/filippomerante/project/github/m5stack-atom-switchbot-lock-pro/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/filippomerante/project/github/m5stack-atom-switchbot-lock-pro/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/filippomerante/project/github/m5stack-atom-switchbot-lock-pro/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
