...
<!-- For checkpoint task examples and patterns, see @/Users/filippomerante/project/github/m5stack-atom-switchbot-lock-pro/.claude/get-shit-done/references/checkpoints.md -->
...
See `/Users/filippomerante/project/github/m5stack-atom-switchbot-lock-pro/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/filippomerante/project/github/m5stack-atom-switchbot-lock-pro/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/filippomerante/project/github/m5stack-atom-switchbot-lock-pro/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
