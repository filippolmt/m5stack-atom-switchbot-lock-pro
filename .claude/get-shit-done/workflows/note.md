...
- **Global scope**: `/Users/filippomerante/project/github/m5stack-atom-switchbot-lock-pro/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/filippomerante/project/github/m5stack-atom-switchbot-lock-pro/.claude/notes/`)
...
2. Glob `/Users/filippomerante/project/github/m5stack-atom-switchbot-lock-pro/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/filippomerante/project/github/m5stack-atom-switchbot-lock-pro/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/filippomerante/project/github/m5stack-atom-switchbot-lock-pro/.claude/notes/` — works in any directory
